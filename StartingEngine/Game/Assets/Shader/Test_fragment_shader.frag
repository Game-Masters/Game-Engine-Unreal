...
color =vec4( mix( texture2D( watertexture,TexCoord)*vec4(0,0.3,0.5,1),texture2D( watertexture,TexCoord)*vec4(0,0.9,0.9,1),texture2D( alphatexture,TexCoord)).xyz *dot(Normals, vec3(0,1,1)),1);
...
//color = mix( vec4( mix( texture2D( watertexture,TexCoord)*vec4(0,0.3,0.5,1),texture2D( watertexture,TexCoord)*vec4(0,0.9,0.9,1),texture2D( alphatexture,TexCoord)).xyz *dot(Normals, vec3(0,1,1)),1),texture2D(foam,TexCoord),texture2D(alphatexture,TexCoord)*ar);
}
}
