...
public:
	...
	bool LoadMesh(const char* path, const char * path_fbx_gen , GameObject* parent=nullptr, bool fbx_with_text = false);
	void LoadRecursive(char ** cursor, GameObject* Parent, const char* path, const char * path_fbx_gen, GameObject* Parent_Gen_World=nullptr, bool fbx_with_text = false);
	GameObject* LoadMesh_variables(char ** cursor, GameObject* parent, int* num_childs, const char* path,const char * path_fbx_gen, GameObject* Parent_Gen_World = nullptr, bool fbx_with_text=false);
