...
public:
	...
	bool LoadMesh(const char* path, const char * path_fbx_gen);
	void LoadRecursive(char ** cursor, GameObject* Parent, const char* path, const char * path_fbx_gen);
	GameObject* LoadMesh_variables(char ** cursor, GameObject* parent, int* num_childs, const char* path,const char * path_fbx_gen);
